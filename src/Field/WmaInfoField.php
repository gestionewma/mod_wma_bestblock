...
namespace Wma\Module\WmaBestblock\Site\Field;
    ...
    public function getInput(): string
    {
        ...
        try {
            ...
            $query = $db->getQuery(true)
                ...
                ->where($db->quoteName('element') . ' = ' . $db->quote('mod_wma_bestblock'))
        ...
        $moduleTitle  = htmlspecialchars(Text::_('MOD_WMA_BESTBLOCK'), ENT_QUOTES, 'UTF-8');

        $logoPath = JPATH_ROOT . '/media/mod_wma_bestblock/images/logo-wma.png';
        $logoUrl  = Uri::root() . 'media/mod_wma_bestblock/images/logo-wma.png';
            ...
            <table style="width:100%;border-collapse:collapse;border:1px solid #dee2e6;border-radius:0 0 8px 8px;overflow:hidden;font-size:.9rem;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding:10px 16px;background:#fff;border-bottom:1px solid #dee2e6;color:#212529;"><code>mod_wma_bestblock</code></td>
                    </tr>
                    <tr>
